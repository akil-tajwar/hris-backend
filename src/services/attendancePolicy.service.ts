...
// GET ALL
export const getAllAttendancePolicies = async (tenantId: number) => {
  ...
  const policies = await db
    .select({
      ...
      // ✅ NEW
      holidayCalendarId: attendancePoliciesModel.holidayCalendarId,
      holidayCalendarName: holidayCalendarModel.name,
      holidayCalendarYear: holidayCalendarModel.year,
    ...
    .leftJoin(
      holidayCalendarModel,
      eq(attendancePoliciesModel.holidayCalendarId, holidayCalendarModel.id)
    )
    .where(eq(attendancePoliciesModel.tenantId, tenantId))
