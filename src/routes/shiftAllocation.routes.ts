// // routes/shiftAllocation.routes.ts
...
// router.post('/create/single',     authenticateUser, createSingleShiftAllocationController)
// router.post('/create/bulk',       authenticateUser, createBulkShiftAllocationController)
...
// router.get('/employee/:employeeId', authenticateUser, getShiftAllocationsByEmployeeController)
...
router.post('/create/bulk',           authenticateUser, createBulkShiftAllocationController)
router.patch('/edit/:id',             authenticateUser, updateShiftAllocationController)
router.patch('/recurrence/:id',       authenticateUser, updateRecurrenceSettingController)
